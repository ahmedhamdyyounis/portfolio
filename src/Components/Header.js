...
export default function Header() {
  ...
  return (
    <header className="d-sm-none position-fixed px-2 py-2 bg-white w-100 z-index-10  ">
      <div className="container position-fixed d-flex justify-content-between align-items-center">
      ...
      >
        <div className="border border-3  img-wrapper mb-3 overflow-hidden rounded-circle">
          <img src='mini-two.jpeg' className='img-fluid'/>
        </div>
