          ...
          <div className="cards d-flex flex-column flex-l-row d-md-flex  gap-4">
            <div className=" col-12 col-l-3 card mb-3 px-3 py-4 bg-white">
              ...
              <p>
                ...
                -Integrated third-party APIs and plugins to add functionality and
                enhance the user experience. <br />
                -Conducted thorough testing and debugging to identify and fix any
                issues in the codebase. <br />
            ...
            <div className=" col-12 col-l-3 card mb-3 px-3 py-4 bg-white">
              ...
              <p>
                ...
                Repellendus voluptatibus excepturi culpa laudantium. Dolor,
                illum.
              </p>
            </div>
            <div className=" col-12 col-l-3 card mb-3 px-3 py-4 bg-white">
